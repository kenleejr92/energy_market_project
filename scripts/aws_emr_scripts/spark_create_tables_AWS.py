...
sc = SparkContext(appName='create_tables')


#Load LMP data
raw_LMP_2011 = sc.textFile('s3://lmpdata/2011_LMPs/2011_LMPs.csv')
raw_LMP_2012 = sc.textFile('s3://lmpdata/2012_LMPs/2012_LMPs.csv')
raw_LMP_2013 = sc.textFile('s3://lmpdata/2013_LMPs/2013_LMPs.csv')
raw_LMP_2014 = sc.textFile('s3://lmpdata/2014_LMPs/2014_LMPs.csv')
raw_LMP_2015 = sc.textFile('s3://lmpdata/2015_LMPs/2015_LMPs.csv')
raw_LMP_2016 = sc.textFile('s3://lmpdata/2016_LMPs/2016_LMPs_thru_5-23.csv')
raw_LMP = raw_LMP_2011.union(raw_LMP_2012).union(raw_LMP_2013).union(raw_LMP_2014).union(raw_LMP_2015).union(raw_LMP_2016)
...
bus_table_rdd.saveAsTextFile('s3://lmpdata/table_columns')
...
for idx in range(len(bus_tables)):
    ...
    unrolled.saveAsTextFile('s3://lmpdata/LMP_table%s' % idx)
